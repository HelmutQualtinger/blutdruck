...
# convert columns to stringS otherwise datetime conversion will fail
    ...
    # drop all rows befor 1 april 2025
    df = df[df['Datum_Uhrzeit'] >= pd.to_datetime("2025-04-01")]
...
table_df.rename(columns={'Systolisch': 'Syst.', 'Diastolisch': 'Diast.', 'Pulse': 'Puls'}, inplace=True)
